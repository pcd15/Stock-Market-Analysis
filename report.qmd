...
Overall, our research aimed to explore the relationship between interest and inflation rates and the performance of the stock market to showcase beneficial investment decisions in the context of today's market and fluctuating economic climates. We hypothesized that the overall stock market would be hurt by high inflation/interest rates and that certain sectors of the economy demonstrate to be less affected than others in these circumstances. Overall, our data has supported our hypotheses to a fair extent, with things like volatile economic climates and/or recessionary pressures being the main confounding variables here. From the data gathered, we conclude that higher returns in the stock market generally occur in times of lower interest and inflation rates, and essential (survival-focused) industries will perform better when the rest of the market is suffering. On the other hand, it can sometimes be difficult to determine when stock market will feature lower returns, as shown in our historical analysis.
