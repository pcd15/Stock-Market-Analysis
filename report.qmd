...
```{r warning = FALSE}
#| label: fig-inflation-and-interest-vs-returns-eda
...
Now for more current day analysis.
...
```{r message = FALSE}
#| label: fig-mean-daily-diff-and-mean-price-by-month
#| fig-cap: ["Monthly average of S&P 500 index's daily difference", "Monthly average of S&P 500 index's daily price"]
#| layout-ncol: 2
...
```{# {r}
# #| label: tbl-five-companies-with-lowest-returns
# #| tbl-cap: "Five companies with lowest year-to-date returns"
# 
# sp500_by_company_and_sector |>
...
```{r warning = FALSE}
#| label: fig-inflation-and-interest-vs-returns-old
#| fig-cap: "Interest and inflation rates vs. S&P 500 returns"
...
```{r}
#| label: tbl-best-ten-years-of-returns-old
...
```{r warning = FALSE}
#| label: tbl-worst-ten-years-of-returns-old
#| tbl-cap: "Ten years with lowest annual S&P 500 returns"
...
```{r}
#|: creating-df-of-averages-of-returns-and-rates-by-decade-old
# excluded 2020 because it's not a whole decade
...
```{r message = FALSE}
#| label: fig-daily-closing-price-old
#| fig-cap: "Daily closing prices for S&P 500 index by month"
...
```{r}
#| label: fig-prop-gains-and-losses-by-month-old
#| fig-cap: "Proportion of daily gains and losses by month"
...
```{r}
#|: creating-df-with-new-dates-and-means-for-following-graphs-old
...
```{r message = FALSE}
#| label: fig-mean-daily-diff-by-month-old
...
```{r message = FALSE}
#| label: fig-mean-price-by-month-old
#| fig-cap: "Monthly average of S&P 500 index's daily price"
...
```{r message = FALSE}
#|: loading-current-day-company-and-sector-data-old
...
```{r}
#| label: fig-overall-performance-of-sp500-by-return-type-old
#| fig-cap: "Number of S&P 500 companies by year-to-date return type"
...
```{r}
#| label: tbl-ten-companies-with-highest-returns-old
...
```{r}
#| label: tbl-ten-companies-with-lowest-returns-old
...
```{r}
#| label: tbl-average-return-by-sector-old
#| tbl-cap: "Average S&P 500 returns by sector"
...
```{r}
#| label: fig-proportion-of-return-types-by-sector-old
#| fig-cap: "Proportion of return types of S&P 500 companies by sector"
...
```{r}
#| label: fig-sector-performance-old
#| fig-cap: "Year-to-date performance of S&P 500 across sectors"
...
```{r}
#| label: fig-essential-vs-nonessential-industries-old
#| fig-cap: "Return distribution of S&P 500 companies by industry type"
