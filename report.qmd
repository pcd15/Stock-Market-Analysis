...
Our first bar graph will analyze just the total number of stocks in the S&P 500 that saw a decrease, and those that saw an increase.
...
Now we will analyze the mean return for all the stocks in a given sector to see which sectors performed the best.
...
This next tibble goes a little more in detail to specifically which companies did the best, and which sectors they were a part of.
...
And what about the opposite end? Which companies were the most negatively affected, and which sectors were they in?
